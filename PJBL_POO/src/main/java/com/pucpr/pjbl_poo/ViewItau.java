...
public class ViewItau extends javax.swing.JFrame {
    private double saldoItau;

    public void setSaldoItau(double saldo){
        this.saldoItau += saldo;
    }

    public double getSaldoItau(){
        return this.saldoItau;
    }
    public ViewItau(double saldoItau) {
        this.saldoItau = saldoItau;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SALDO ITAU: R$" + this.saldoItau);
