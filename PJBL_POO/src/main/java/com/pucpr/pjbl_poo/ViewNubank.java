...
public class ViewNubank extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SALDO NUBANK: R$");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewNubank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewNubank().setVisible(true);
            }
        });
    }
