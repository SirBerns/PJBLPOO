...
public class ViewBradesco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SALDO BRADESCO R$");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBradesco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewBradesco().setVisible(true);
            }
        });
    }
