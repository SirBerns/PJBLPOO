...
public class ViewC6 extends javax.swing.JFrame {
    private double saldoC6;

    public void setSaldoC6(double saldo){
        this.saldoC6 += saldo;
    }

    public double getSaldoC6(){
        return this.saldoC6;
    }
    public ViewC6(double saldoC6) {
        this.saldoC6 = saldoC6;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SALDO C6: R$" + this.saldoC6);
